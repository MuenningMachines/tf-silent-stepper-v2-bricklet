...
typedef struct {
	...
	uint32_t register_to_write_mask;
	uint32_t register_to_read_mask;

	uint8_t write_buffer[5];
	uint8_t read_buffer[5];

	uint32_t current_read_bit;
...
#define TMC2130_SPI_READ  (0 << 7)
#define TMC2130_SPI_WRITE (1 << 7)

#define TMC2130_CLOCK_FREQUENCY ((uint32_t)12000000) // 12MHz supplied by external clock (PWM with period 8, duty cycle 4 @2*mck)
